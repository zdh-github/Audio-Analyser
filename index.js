        ...
        audioAnalyser.getBuffer = function () {
            ...
            for (var x = 0; x < bufferLength; x++) {
                if (x % 2 === 0) {
                    ...
                    renderer.fillRect(bufferUnitWidth * x, canvas.height / 2 - buffer[x], bufferUnitWidth / 2, buffer[x] || 1);
                }
                else {
                    renderer.fillStyle = "#47f282";
                    renderer.fillRect(bufferUnitWidth * x, canvas.height / 2, bufferUnitWidth / 2, buffer[x] || 1);
                }
            }
        };
